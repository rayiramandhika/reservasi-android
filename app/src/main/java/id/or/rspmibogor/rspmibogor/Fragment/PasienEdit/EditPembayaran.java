...
public class EditPembayaran extends AbstractStep {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            jenisPembayaran.setText(data.getString("jenisPembayaran"));
                            namaPenjamin.setText(data.getString("namaPenjamin"));

                            String type = data.getString("type");

                            if(type.equals("Pasien Baru")) rgLama.setChecked(true);
                            else rgBaru.setChecked(true);
    ...
    private void saveData()
    {
        ...
        Log.d(TAG, "saveData - identitas_alamat: " + identitas_alamat.toString());
