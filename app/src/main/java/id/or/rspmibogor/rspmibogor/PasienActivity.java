...
public class PasienActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initData()
    {
        ...
        String url = "http://103.23.20.160:1337/v1/pasien";
    ...
    private void getNewData()
    {
        ...
        String url = "http://103.23.20.160:1337/v1/pasien?where={%22id%22:{%22>%22:"+last_id+"},%22user%22:"+user_id+"}";
        spinner.setVisibility(View.VISIBLE);
    ...
    /*private void loadMore(Integer index)
    {
        ...
        final String jwTokenSP = sharedPreferences.getString("jwtToken", null);
        String url = "http://103.23.20.160:1337/v1/pasien?sort=id%20DESC&skip="+skip.toString();
