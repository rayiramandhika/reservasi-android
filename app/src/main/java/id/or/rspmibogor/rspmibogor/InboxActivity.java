...
public class InboxActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initDataset() {
        ...
        String url = "http://103.23.20.160:1337/v1/inbox?sort=createdAt%20DESC";
    ...
    {
        String url = "http://103.23.20.160:1337/v1/inbox?sort=createdAt%20DESC&limit="+skip.toString();
    ...
    private void loadMore(Integer index) {
        ...
        String url = "http://103.23.20.160:1337/v1/inbox?sort=createdAt%20DESC&skip="+skip.toString();
